        ...
        <>
            ...
            <section id='experience' className='relative overflow-hidden flex flex-col text-gray-600 body-font'>
                ...
                <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
                    <div data-aos='fade-left' data-aos-delay='400' className='relative lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0'>
                        ...
                        <img src="" alt="" className='object-cover md:w-[300px] md:h-[450px] object-center rounded relative z-10' />
                    </div>

                    <div data-aos='fade-right' data-aos-delay='400' className='lg:flex-grow md:w-1/2 lg:pl-8 flex flex-col md:items-start md:text-left items-center '>
                        ...
                        <p className='mb-8 text-white leading-relaxed'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sequi, qui. Architecto doloremque molestiae, ut magnam reiciendis esse aut repellendus optio dolores dolorum sequi culpa molestias at tempore libero soluta. Aut.</p>
